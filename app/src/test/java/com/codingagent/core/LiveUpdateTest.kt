...
class LiveUpdateTest {
    ...
    fun `nexa package validator accepts manifest-declared shards`() {
        ...
        packageDir.resolve("nexa.manifest").writeText("{\"ModelName\":\"qwen3-8b\",\"PluginId\":\"npu\"}")
        ...
        val result = store.installPackage(packageDir, "qwen3-8b", "nexa-npu", action, VerificationReport(true, emptyList()))
